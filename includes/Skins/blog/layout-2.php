...
<article class="unlockafe-blog-element-four">
				...
				foreach ( $meta_op as $meta_key ) {
					...
					switch ( $meta_key ) {
						...
						case 'comment':
							...
							echo '<li><a href="' . esc_url( get_comments_link() ) . '">' . esc_html( $comments_number ) . ' ' . wp_kses( $text, $allowed_tags ) . '</a></li>';
							break;
					}
				}
				?>
