...
$query_args = array(
    'post_type'      => 'product',
    'posts_per_page' => isset($args['unlockafe_product_show_length']) ? intval($args['unlockafe_product_show_length']) : -1,
    'post_status'    => 'publish',
    'orderby'        => isset($args['post_source']) ? sanitize_key($args['post_source']) : 'date',
            ...
            <div class="swiper unlockafe-product-slide">
                <div class="swiper-wrapper">
                    <?php foreach ($posts as $post) :
                        ...
                        // $add_to_cart_text = $product->is_in_stock() ? 'Add To Cart' : 'Out of Stock';
                        ...
                        <div class="swiper-slide product-slide">
                            <div class="product-wrapper">
                                <div class="thumbnail-wrapper">
                                    <?php if (isset($args['unlockafe_product_carousel_image_clickable']) && $args['unlockafe_product_carousel_image_clickable'] === 'yes') : ?>
                                    ...
                                    <div class="product-label on-thumbnail">
                                        <?php if ($product->is_on_sale() && (isset($args['unlockafe_product_carousel_show_sale']) && $args['show_slider_title'] === 'yes')) : ?>
                                            <span class="onsale"><?php esc_html_e('Sale', 'unlock-addons-for-elementor'); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <?php if (isset($args['unlockafe_product_carousel_show_add_to_cart']) && $args['unlockafe_product_carousel_show_add_to_cart'] === 'yes') : ?>
                                ...
                                <div class="meta-wrapper">
                                    <?php if (isset($args['show_slider_title']) && $args['show_slider_title'] === 'yes') :
                                    ...
                                    <?php if (isset($args['unlockafe_product_carousel_price']) && $args['unlockafe_product_carousel_price'] === 'yes') : ?>
                                        <div class="unlockafe-product-price">
                                        <?php echo $product ? wp_kses_post($product->get_price_html()) : ""; ?>
                                        </div>
                                    <?php endif; ?>
                                    <?php if (isset($args['unlockafe_product_carousel_excerpt']) && $args['unlockafe_product_carousel_excerpt'] === 'yes') : ?>
                                        <div class="excerpt short_description">
                                        <?php 
                                            echo esc_html(wp_trim_words(
                                                get_the_excerpt($post_id), 
                                                isset($args['unlockafe_product_carousel_excerpt_length']) ? intval($args['unlockafe_product_carousel_excerpt_length']) : 55, 
                                                isset($args['unlockafe_product_carousel_excerpt_expanison_indicator']) ? esc_html($args['unlockafe_product_carousel_excerpt_expanison_indicator']) : '...'
                                            )); 
                                            ?>
                                        </div>
                                    <?php endif; ?>
