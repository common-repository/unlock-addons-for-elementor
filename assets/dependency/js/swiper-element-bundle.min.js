      ...
      checkOverflow: {
        checkOverflow: function () {
          ...
          !0 === s.allowSlideNext && (e.allowSlideNext = !e.isLocked),
            ...
            t !== e.isLocked && e.emit(e.isLocked ? "lock" : "unlockafe");
        },
      },
      classes: {
        addClasses: function () {
  ...
  const ge = [
    ...
    function (e) {
      ...
      s({
        ...
        a("toEdge fromEdge lock unlockafe", () => {
          l();
        }),
        a("destroy", () => {
          p();
    ...
    function (e) {
      ...
      s({
        ...
        i("update resize observerUpdate lock unlockafe changeDirection", () => {
          b();
        }),
        i("setTranslate", () => {
          g();
    ...
    function (e) {
      ...
      i("beforeInit", () => {
        ...
        i("fromEdge toEdge afterInit lock unlockafe", () => {
